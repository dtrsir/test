...
<body>
   <jk:topper logoName="JKOSS"></jk:topper>
               ...
               <dd><ul>
						<li><a data-href="${pageContext.request.contextPath}/device/deviceType.do?method=list" data-title="设备类型" href="javascript:void(0)">类型列表</a></li>
					</ul>
                <ul>
						<li><a data-href="${pageContext.request.contextPath}/device/device.do?method=list" data-title="设备管理" href="javascript:void(0)">设备管理</a></li>
					</ul>
					 <ul>
						<li><a data-href="${pageContext.request.contextPath}/device/deviceRepair.do?method=list" data-title="设备维修" href="javascript:void(0)">设备维修</a></li>
					</ul>
				</dd>
			  <!-- 以上是菜单 -->
			</dl>
