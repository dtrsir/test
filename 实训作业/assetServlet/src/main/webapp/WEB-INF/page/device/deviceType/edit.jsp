...
<body>
	<article class="page-container">
		<form class="form form-horizontal" id="form" method="post" action="${pageContext.request.contextPath}${requestScope.record != null ?  '/device/deviceType.do?method=update' :'/device/deviceType.do?method=insert'  }">
			<!-- 隐藏表单 -->
