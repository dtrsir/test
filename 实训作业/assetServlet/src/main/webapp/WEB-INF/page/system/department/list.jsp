	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;"
				onclick="batchdel('${pageContext.request.contextPath}/system/role.do?method=batchDelete')"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除 </a> <a href="javascript:;"
				onclick="insert('添加','${pageContext.request.contextPath}/system/role.do?method=toInsert','800','500')"
				...
				<c:forEach items="${requestScope.records }" var="record">
					<tr class="text-c">
						...
						<td class="td-manage"><a title="编辑" href="javascript:;"
							onclick="update('编辑','${pageContext.request.contextPath}/system/role.do?method=toUpdate&id=${record.id }','1','800','500')"
							class="ml-5" style="text-decoration: none"><i
								class="Hui-iconfont">&#xe6df;</i></a> <a title="删除"
							href="javascript:;"
							onclick="del(this,'${pageContext.request.contextPath}/system/role.do?method=delete&id=${record.id}')"
							class="ml-5" style="text-decoration: none"><i
